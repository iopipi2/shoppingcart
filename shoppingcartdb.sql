...
INSERT INTO `cart` VALUES (1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `cart_line` (
  ...
  CONSTRAINT `fk_cart_bill` FOREIGN KEY (`bill_id`) REFERENCES `cart` (`id`),
...
INSERT INTO `user` VALUES (52,'iamghost06@gmail.com','123456','Nguyen Ngoc Bach',NULL,NULL,NULL,'ROLE_USER',1,NULL),(54,'iamghost827@gmail.com','123456','Nguyễn Ngọc Bách','0969374719','64, Nguyễn Văn Trỗi, Hà Đông, Hà Nội',NULL,'ROLE_ADMIN',1,'ba2b7156370cf989082c7daa8a8c336f.jpg'),(90,'ngocbachnguyen100@gmail.com','$2a$10$XZOHSDmtkUdck5M7NdelMe6Xnupo1csaviwZ3JLr8yoCUEnUYnRDm','Nguyễn Ngọc Bách',NULL,NULL,'2021-09-24 09:08:31','ROLE_USER',1,'69402738_2326329874274213_15742996465057792_n.jpg');
...
-- Dump completed on 2022-07-28 11:50:17
